...
\thd{Findable}       & Repository and persistent identifier/URL are provided; file/folder names are meaningful; metadata are searchable. & $\square$~Yes~/~$\boxtimes$~No & Repository URL published; no DOI at submission; file and folder names are meaningful and \texttt{registry.csv} is searchable \\ \hline
